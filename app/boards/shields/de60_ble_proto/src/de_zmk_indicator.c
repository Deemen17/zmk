...
static void hid_indicators_status_update_cb(const zmk_event_t *eh) { get_lock_indicators(); }
...
static void ble_active_profile_update_cb(const zmk_event_t *eh) { ble_active_profile_update(); }
